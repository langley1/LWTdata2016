...
wilcox.test(Means ~ release, data = fullbudget_pred, paired = TRUE,
       alternative = "less")
```
RESULTS: The troop's mean hourly display of predator-related behaviors are significantly higher in the pre-release stage than post-release (V=0, p=6.104e-05,n=15).
