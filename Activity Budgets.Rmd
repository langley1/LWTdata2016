...
wilcox.test(Means ~ release, data = fullbudget_other, paired = TRUE,
        alternative = "greater")
```
RESULTS: The troop's mean hourly count of behavior displays from the other cateogiry was significantly higher during the post-release stage (V=103, p=0.006226,n=15).
