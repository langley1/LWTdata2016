---
title: "2016 LWT Vervet Monkey Rehab & Release"
...
# Importing the post-focals dataset (Not full) See Post-Release Rmd for Full
```{r}
...
### Batman vs Pops: Wilcox test for Activity Budgets 
```{r}
#Batman
...
#Batman VS Pops PREDATOR category
wilcox.test(Pops_budget$count[Pops_budget$behavior.category == "Predator"], Bat_budget$count[Bat_budget$behavior.category == "Predator"])

#Batman VS Pops SOCIAL category
wilcox.test(Pops_budget$count[Pops_budget$behavior.category == "Social"], Bat_budget$count[Bat_budget$behavior.category == "Social"])

#Batman VS Pops FEEDING category
wilcox.test(Pops_budget$count[Pops_budget$behavior.category == "Feeding"], Bat_budget$count[Bat_budget$behavior.category == "Feeding"])

#Batman VS Pops LOCOMOTE category
wilcox.test(Pops_budget$count[Pops_budget$behavior.category == "Locomote"], Bat_budget$count[Bat_budget$behavior.category == "Locomote"])

#Batman VS Pops OTHER category
wilcox.test(Pops_budget$count[Pops_budget$behavior.category == "Other"], Bat_budget$count[Bat_budget$behavior.category == "Other"])

#Batman VS Pops STRESS category
wilcox.test(Pops_budget$count[Pops_budget$behavior.category == "Stress"], Bat_budget$count[Bat_budget$behavior.category == "Stress"])

pvals<- c(0.014, 0.195, 0.824, 0.047, 0.368, 0.067) #The p-values from the wilcox.test
p.adjust(pvals, method = "bonferroni") #the p-vales after multiple comparisons correction Bonferroni 
...
After a Bonferroni correction, Batman's mean hourly behavior count for each of the six behavioral categories was not signifcantly different from Pop's mean hourly behavioral count. 

### Batman vs Zip: Wilcox test for Activity Budgets 
```{r}
Zip_budget<- Zip_budget %>%
  mutate(ID = "Zip")

#Batman VS Zip PREDATOR category
wilcox.test(Zip_budget$count[Zip_budget$behavior.category == "Predator"], Bat_budget$count[Bat_budget$behavior.category == "Predator"])

#Batman VS Zip SOCIAL category
wilcox.test(Zip_budget$count[Zip_budget$behavior.category == "Social"], Bat_budget$count[Bat_budget$behavior.category == "Social"])

#Batman VS Zip FEEDING category
wilcox.test(Zip_budget$count[Zip_budget$behavior.category == "Feeding"], Bat_budget$count[Bat_budget$behavior.category == "Feeding"])

#Batman VS Zip LOCOMOTE category
wilcox.test(Zip_budget$count[Zip_budget$behavior.category == "Locomote"], Bat_budget$count[Bat_budget$behavior.category == "Locomote"])

#Batman VS Zip OTHER category
wilcox.test(Zip_budget$count[Zip_budget$behavior.category == "Other"], Bat_budget$count[Bat_budget$behavior.category == "Other"])

#Batman VS Zip STRESS category
wilcox.test(Zip_budget$count[Zip_budget$behavior.category == "Stress"], Bat_budget$count[Bat_budget$behavior.category == "Stress"])

pvals<- c(0.312, 0.033, 0.001459, 0.896, 0.0128, 0.0141) #The p-values from the wilcox.test
p.adjust(pvals, method = "bonferroni") #the p-vales after multiple comparisons correction Bonferroni 

median(Bat_budget$count[Bat_budget$behavior.category == "Feeding"]) #median feeding count of 3 times per hour for Batman

median(Zip_budget$count[Zip_budget$behavior.category == "Feeding"]) #median feeding count of 5 times per hour for Zip
```

After Bonferroni correction, the time spent feeding was significantly different between Zip and Batman (W = 3247, p <0.05) Batman fed less per hour than Zip, with median feeding counts of 3 and 5 per hour, respectively.

### Batman vs Jack: Wilcox test for Activity Budgets 
```{r}
Jack_budget<- Jack_budget %>%
  mutate(ID = "Jack")

#Batman VS Jack PREDATOR category
wilcox.test(Jack_budget$count[Jack_budget$behavior.category == "Predator"], Bat_budget$count[Bat_budget$behavior.category == "Predator"])

#Batman VS Jack SOCIAL category
wilcox.test(Jack_budget$count[Jack_budget$behavior.category == "Social"], Bat_budget$count[Bat_budget$behavior.category == "Social"])

#Batman VS Jack FEEDING category
wilcox.test(Jack_budget$count[Jack_budget$behavior.category == "Feeding"], Bat_budget$count[Bat_budget$behavior.category == "Feeding"])

#Batman VS Jack LOCOMOTE category
wilcox.test(Jack_budget$count[Jack_budget$behavior.category == "Locomote"], Bat_budget$count[Bat_budget$behavior.category == "Locomote"])

#Batman VS Jack OTHER category
wilcox.test(Jack_budget$count[Jack_budget$behavior.category == "Other"], Bat_budget$count[Bat_budget$behavior.category == "Other"])

#Batman VS Jack STRESS category
wilcox.test(Jack_budget$count[Jack_budget$behavior.category == "Stress"], Bat_budget$count[Bat_budget$behavior.category == "Stress"])

pvals<- c(0.1785, 0.91, 0.03057, 0.3295, 0.06099, 0.02417) #The p-values from the wilcox.test
p.adjust(pvals, method = "bonferroni") #the p-vales after multiple comparisons correction Bonferroni 
```

Pre-release behavioral activity budget was not significalty different between Batman and Jack, an adult male who died. 

### Batman vs Bart: Wilcox test for Activity Budgets 
```{r}
Bart_budget<- Bart_budget %>%
  mutate(ID = "Bart")

#Batman VS Bart PREDATOR category
wilcox.test(Bart_budget$count[Bart_budget$behavior.category == "Predator"], Bat_budget$count[Bat_budget$behavior.category == "Predator"])

#Batman VS Bart SOCIAL category
wilcox.test(Bart_budget$count[Bart_budget$behavior.category == "Social"], Bat_budget$count[Bat_budget$behavior.category == "Social"])

#Batman VS Bart FEEDING category
wilcox.test(Bart_budget$count[Bart_budget$behavior.category == "Feeding"], Bat_budget$count[Bat_budget$behavior.category == "Feeding"])

#Batman VS Bart LOCOMOTE category
wilcox.test(Bart_budget$count[Bart_budget$behavior.category == "Locomote"], Bat_budget$count[Bat_budget$behavior.category == "Locomote"])

#Batman VS Bart OTHER category
wilcox.test(Bart_budget$count[Bart_budget$behavior.category == "Other"], Bat_budget$count[Bat_budget$behavior.category == "Other"])

#Batman VS Bart STRESS category
wilcox.test(Bart_budget$count[Bart_budget$behavior.category == "Stress"], Bat_budget$count[Bat_budget$behavior.category == "Stress"])

pvals<- c(0.6065, 0.5958, 0.03961, 0.6351, 0.1641, 0.097) #The p-values from the wilcox.test
p.adjust(pvals, method = "bonferroni") #the p-vales after multiple comparisons correction Bonferroni 
```
Pre-release behavioral activity budget was not significalty different between Batman and Bart, an adult male who disappeared and was presumed to have emigrated.
