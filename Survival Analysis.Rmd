...
post_surv_edited_with_centrality<- post_surv_edited %>%
  ...
  mutate(David_scores_post = #Adding in a column for the post_release davids scores
           case_when(FOCAL.ID == "PO" ~ as.numeric(9.854),
...
#Cox multiple for Davids scores, sex, age, and predator POST, and social prox
