...
---
title: "Post-release survival and behavior of rehabilitated vervet monkeys (*Chlorocebus pygerythrus rufoviridis*) in Malawi"
output: md_document
---
...
wilcox.test(wide$pre, wide$post,
            ...
            alternative = "greater")
```
RESULTS: The troop's mean Shannon Diversity pre-release is significantly greater than the troop's mean Shannon Diversity post-release (V= 105, p=0.008362, n=15).
